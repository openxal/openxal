 ...
 * @since   Oct 10, 2011
 */
public class ScannerConfigDisplay extends JTabbedPane /* implements IConfigView */ {
    ...
    public enum PANE {
        ...
        SCAN("Scan", ScanConfigPanel.class),
        
        /** Signal processing parameters panel */
        PRCG("DataPrc", PrcgConfigPanel.class),
        
        /** Scanning actuator configuration parameters panel */
...
//        TRIG("Trigger", TrgrConfigPanel.class);
    ...
    private class PanelFocusEvent implements ChangeListener {
        ...
        public void stateChanged(ChangeEvent arg0) {
            WireScanner     ws = ScannerConfigDisplay.this.getCurrentDevice();
            
            if (ws == null)
                return;
            
            if (!BOL_DO_CONNTEST) {
                this.pnlCfg.setDevice(ws);
                
                return;
            }

            if (this.pnlCfg.connectionTest(ws)) {
                this.pnlCfg.setDevice(ws);
    ...
    /** the currently selected wire scanner device */
     ...
     * @author    Christopher K. Allen
     */
    public ScannerConfigDisplay(String strTitle, int enmAlign) {
        super(enmAlign);
     ...
     * @since  Oct 11, 2011
     */
    public WireScanner  getCurrentDevice() {
     ...
     *
     * @param ws    wire scanner for which configuration parameters are to be displayed
     *  
     * @since   Oct 10, 2011
     * @author  Christopher K. Allen
     *
...
//    
//    /**
//     * We need to update the display of each panel in case any of their parameters has
//     * changed.
//     * 
//     * @since Jul 31, 2012
...
//
//    /**
//     * Just clears all the panels.  The current wire scanner device is no longer valid since
//     * the entire accelerator has changed.
//     * 
//     * @since Jul 31, 2012
