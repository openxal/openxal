...
public class PVLogSnapshotChooser {
    ...
    protected Container buildSnapshotDetailView() {				
        ...
        SnapshotDetailTableModel detailTableModel = new SnapshotDetailTableModel(_controller);
        _controller.addBrowserControllerListener(detailTableModel);
        JTable dataTable = new JTable(detailTableModel);
    ...
    protected Container buildResultView() {
        ...
        JButton done = new JButton("Select");
            ...
            public void actionPerformed(ActionEvent event) {
                pvLogId = ( Long.valueOf(pvLogIdField.getText())).longValue();
