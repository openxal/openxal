...
import xal.tools.math.r3.R3x3EigenDecomposition;
...
public class TestTemplate {
	...
	public static void buildTestingResources() {
		...
		MAT_S = new R3x3(new double[][] { { 1.0, 0.0, 0.0 }, { 0.0, 2.0, 0.0 },
				{ 0.0, 0.0, 3.0 } });
	...
	@Test
	public void testJacobiDecomposition() throws IllegalArgumentException,
	...
	@Test
	public void testEigenValueDecomposition() throws IllegalArgumentException,
			InstantiationException {
		R3x3 matT = MAT_S;
