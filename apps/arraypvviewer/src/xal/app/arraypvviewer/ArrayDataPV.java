...
public class ArrayDataPV {
    ...
    private final Vector<UpdatingController> controllers = new Vector<UpdatingController>();
     ...
     */
    protected Vector<UpdatingController> getControllers() {
        return new Vector<UpdatingController>( controllers );
    }
    ...
    public void removeControllers() {
        Vector<UpdatingController> cntrls = getControllers();
        for ( int i = 0; i < cntrls.size(); i++ ) {
            ( cntrls.get( i ) ).removeArrayDataPV( this );
        }
    }
