...
public class ScanDocument2D extends AcceleratorDocument {
	...
	public void readScanDocument(URL url) {
		...
		if (readAdp != null) {
			...
			DataAdaptor scan2D_Adaptor =  readAdp.childAdaptor(dataRootName_SR);

			DataAdaptor params_scan2D =  scan2D_Adaptor.childAdaptor(paramsName_SR);
			DataAdaptor paramPV_scan2D =  scan2D_Adaptor.childAdaptor(paramPV_SR);
			DataAdaptor scanPV_scan2D =  scan2D_Adaptor.childAdaptor(scanPV_SR);
			DataAdaptor measurePVs_scan2D =  scan2D_Adaptor.childAdaptor(measurePVs_SR);
			DataAdaptor validationPVs_scan2D =  scan2D_Adaptor.childAdaptor(validationPVs_SR);

			DataAdaptor tmp_analysisConfig =  scan2D_Adaptor.childAdaptor(analysisConfig_SR);
			...
			//set font
			DataAdaptor params_font =  params_scan2D.childAdaptor("font");
			...
			DataAdaptor params_scan_panel_title =  params_scan2D.childAdaptor("scan_panel_title");
			...
			//pv logger Id
			DataAdaptor pv_logger_id =  params_scan2D.childAdaptor("pv_logger_id");
			...
			//set scan control panel labels
			DataAdaptor params_scan_panel_paramRB_label =  params_scan2D.childAdaptor("sc_panel_paramRB_label");
			...
			DataAdaptor params_scan_panel_paramStep_label =  params_scan2D.childAdaptor("sc_panel_paramStep_label");
			...
			DataAdaptor params_scan_panel_scanRB_label =  params_scan2D.childAdaptor("sc_panel_scanRB_label");
			...
			DataAdaptor params_scan_panel_scanStep_label =  params_scan2D.childAdaptor("sc_panel_scanStep_label");
			...
			DataAdaptor params_scan_panel_paramUnits_label =  params_scan2D.childAdaptor("sc_panel_paramUnits_label");
			...
			DataAdaptor params_scan_panel_scanUnits_label =  params_scan2D.childAdaptor("sc_panel_scanUnits_label");
			...
			DataAdaptor paramPV_tree_node_name =  params_scan2D.childAdaptor("parameterPV_tree_name");
			...
			DataAdaptor scanPV_tree_node_name =  params_scan2D.childAdaptor("scanPV_tree_name");
			...
			DataAdaptor measuredPVs_tree_node_name =  params_scan2D.childAdaptor("measuredPVs_tree_name");
			...
			DataAdaptor validationPVs_tree_node_name =  params_scan2D.childAdaptor("validationPVs_tree_name");
			...
			DataAdaptor params_UseTimeStamp =  params_scan2D.childAdaptor("UseTimeStamp");
			...
			DataAdaptor params_limits =  params_scan2D.childAdaptor("limits_step_delay");
			...
			DataAdaptor params_trigger =  params_scan2D.childAdaptor("beam_trigger");
			...
			DataAdaptor params_averg =  params_scan2D.childAdaptor("averaging");
			...
			DataAdaptor params_validation =  params_scan2D.childAdaptor("validation");
			...
			DataAdaptor params_paramPV_name =  paramPV_scan2D.childAdaptor("PV");
			...
			DataAdaptor params_paramPV_nameRB =  paramPV_scan2D.childAdaptor("PV_RB");
			...
			//set scan PVs
			DataAdaptor scan_PV_name_DA =  scanPV_scan2D.childAdaptor("PV");
			...
			DataAdaptor scan_PV_RB_name_DA =  scanPV_scan2D.childAdaptor("PV_RB");
			...
			//set validation PVs
			for ( final DataAdaptor validationPV_DA : validationPVs_scan2D.childAdaptors() ) {
			...
			for ( final DataAdaptor measuredPV_DA : measurePVs_scan2D.childAdaptors() ) {
	...
	public void saveDocumentAs(URL url) {
		...
		DataAdaptor scan2D_Adaptor =  da.createChild(dataRootName_SR);
		//scan2D_Adaptor.setValue("title",getTitle());
		scan2D_Adaptor.setValue("title", url.getFile());

		DataAdaptor params_scan2D =  scan2D_Adaptor.createChild(paramsName_SR);
		DataAdaptor paramPV_scan2D =  scan2D_Adaptor.createChild(paramPV_SR);
		DataAdaptor scanPV_scan2D =  scan2D_Adaptor.createChild(scanPV_SR);
		DataAdaptor validationPVs_scan2D =  scan2D_Adaptor.createChild(validationPVs_SR);
		analysisConfig =  scan2D_Adaptor.createChild(analysisConfig_SR);
		DataAdaptor measurePVs_scan2D =  scan2D_Adaptor.createChild(measurePVs_SR);

		//make analysis configuration part of the DataAdaptor
		analysisController.dumpChildAnalysisConfig(analysisConfig);

		//dump parameters
		DataAdaptor params_font =  params_scan2D.createChild("font");
		...
		DataAdaptor params_scan_panel_title =  params_scan2D.createChild("scan_panel_title");
		params_scan_panel_title.setValue("title", scanController.getTitle());

		//dump PV Logger Id
		DataAdaptor pv_logger_id =  params_scan2D.createChild("pv_logger_id");
		pv_logger_id.setValue("Id", (int) snapshotId);

		//dump scan control panel labels
		DataAdaptor params_scan_panel_paramRB_label =  params_scan2D.createChild("sc_panel_paramRB_label");
		params_scan_panel_paramRB_label.setValue("label", scanController.getParamRB_Label().getText());
		DataAdaptor params_scan_panel_paramStep_label =  params_scan2D.createChild("sc_panel_paramStep_label");
		params_scan_panel_paramStep_label.setValue("label", scanController.getParamScanStep_Label().getText());
		DataAdaptor params_scan_panel_scanRB_label =  params_scan2D.createChild("sc_panel_scanRB_label");
		params_scan_panel_scanRB_label.setValue("label", scanController.getValueRB_Label().getText());
		DataAdaptor params_scan_panel_scanStep_label =  params_scan2D.createChild("sc_panel_scanStep_label");
		params_scan_panel_scanStep_label.setValue("label", scanController.getScanStep_Label().getText());

		DataAdaptor params_scan_panel_paramUnits_label =  params_scan2D.createChild("sc_panel_paramUnits_label");
		params_scan_panel_paramUnits_label.setValue("label", scanController.getParamUnitsLabel().getText());
		DataAdaptor params_scan_panel_scanUnits_label =  params_scan2D.createChild("sc_panel_scanUnits_label");
		params_scan_panel_scanUnits_label.setValue("label", scanController.getUnitsLabel().getText());

		//dump names of the tree panel items
		DataAdaptor paramPV_tree_node_name =  params_scan2D.createChild("parameterPV_tree_name");
		paramPV_tree_node_name.setValue("name", rootParameterPV_Node.getName());
		DataAdaptor scanPV_tree_node_name =  params_scan2D.createChild("scanPV_tree_name");
		scanPV_tree_node_name.setValue("name", rootScanPV_Node.getName());
		DataAdaptor measuredPVs_tree_node_name =  params_scan2D.createChild("measuredPVs_tree_name");
		measuredPVs_tree_node_name.setValue("name", measuredPVs_Node.getName());
		DataAdaptor validationPVs_tree_node_name =  params_scan2D.createChild("validationPVs_tree_name");
		validationPVs_tree_node_name.setValue("name", validationPVs_Node.getName());

		DataAdaptor params_UseTimeStamp =  params_scan2D.createChild("UseTimeStamp");
		params_UseTimeStamp.setValue("yes", useTimeStampButton.isSelected());

		//dump lowLimits uppLimits Step time_delay
		DataAdaptor params_limits =  params_scan2D.createChild("limits_step_delay");
		...
		DataAdaptor params_trigger =  params_scan2D.createChild("beam_trigger");
		...
		//average controller
		DataAdaptor params_averg =  params_scan2D.createChild("averaging");
		...
		//validation control
		DataAdaptor params_validation =  params_scan2D.createChild("validation");
		...
		for (int i = 0, n = measuredValuesV.size(); i < n; i++) {
			MeasuredValue mv_tmp = measuredValuesV.get(i);
			DataAdaptor measuredPV_DA =  measurePVs_scan2D.createChild("MeasuredPV");
