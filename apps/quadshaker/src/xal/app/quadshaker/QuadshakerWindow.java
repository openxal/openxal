...
/**
 *  QuadshakerWindow is a subclass of XalWindow used in the Quadshaker
 *  application. It has a main panel and the message text field for messages.
 *
 *@author     shishlo
 */

public class QuadshakerWindow extends XalWindow {
  ...
  /**
   *  Creates a new instance of QuadshakerWindow
   *
   *@param  aDocument  The XalDocument for this application.
   */
  public QuadshakerWindow(XalDocument aDocument) {
    super(aDocument);
    makeContent();
    pack();
  }
