...
public class RFPhaseShakerWindow extends AcceleratorWindow {
  ...
  /**
   *  Creates a new instance of RFPhaseShakerWindow
   *
   *@param  aDocument  The XalDocument for this application.
   */
  public RFPhaseShakerWindow(AcceleratorDocument aDocument) {
    super(aDocument);
    makeContent();
    pack();
  }
