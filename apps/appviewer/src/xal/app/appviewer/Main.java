...
/**
 * Main is the ApplicationAdaptor for the appviewer application.
 *
 * @author  tap
 */
public class Main extends ApplicationAdaptor {
    ...
    public XalDocument newDocument(java.net.URL url) {
        return new AppViewerDocument(url);
    }
    ...
    static public void main(String[] args) {
        try {
			...
			Logger.getLogger("global").log( Level.SEVERE, "Error while attempting to launch the application.", exception );
			System.exit(-1);
        }
    }
}
