...
public class SimpleChartPopupMenu extends JPopupMenu implements MouseListener {
     ...
     */
    public SimpleChartPopupMenu(xal.tools.plot.FunctionGraphsJPanel aChart) {
		this( aChart, new xal.tools.plot.FunctionGraphsPopupAdaptor(aChart) );
    }
     ...
     * @return The popup menu instance
     */
    static public SimpleChartPopupMenu addPopupMenuTo(xal.tools.plot.FunctionGraphsJPanel aChart) {
		return addPopupMenuTo( aChart, new xal.tools.plot.FunctionGraphsPopupAdaptor(aChart) );
    }
