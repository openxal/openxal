...
export JYTHONPATH=$JYTHONPATH:/opt/codac-4.1/lib/openxal/openxal.library-1.0.1-SNAPSHOT.jar
...
export JRUBY_CP=$JRUBY_CP:/opt/codac-4.1/lib/openxal/openxal.library-1.0.1-SNAPSHOT.jar
