...
/** Objective to minimize the mean Beta error. */
public class BetaMeanErrorObjective extends OpticsObjective {
	 ...
	 * Constructor
	 */
	public BetaMeanErrorObjective( final String name, final int axis, final double tolerance ) {
		super( name );
	...
	public double getValue( final Map<Variable, Number> trialValues, final Simulation simulation, final Simulation designSimulation ) {
		return simulation.getMeanBetaError( designSimulation )[ _axis ];
	}
