...
public class ReadRawDataPanel {
	...
	private int[] nWires_arr = {32, 26, 32, 16, 1};
	private int[] nChannels_arr = {30, 26, 30, 16, 1};
	...
	/**
	 * Adds an ActionListener that listenes to reading the new waveform data
	 * file
	 *
	...
	/**
	 * Removes all ActionListeners that listen to reading the new waveform
	 * data file
	 *
	...
	/**
	 * Notifies all listeners that the type index of emittance device has
	 * been changed
	 */
	...
	/**
	 * Adds a new ActionListener to listen the change in the type device
	 * index
	 *
	 * @param al The ActionListener
	 */
	...
	/**
	 * Removes an ActionListeners to listen the change in the type device
	 * index
	 *
	 * @param al The ActionListener
	 */
	...
	/**
	 * Returns a vector with ActionListeners to listen the change in the
	 * type device index
	 *
	 * @return The vector with ActionListeners
	 */
	...
	/**
	 * Sets the parameters on the panel according to information in the XML
	 * data adapter
	 *
	 * @param rawDataPanelData The XML data adapter
	 */
