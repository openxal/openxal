...
/**
 *  MagnetcyclingWindow is a subclass of XalWindow used in the Magnetcycling
 *  application. It has a main panel and the message text field for messages.
 *
 *@author     shishlo
 */

public class MagnetcyclingWindow extends XalWindow {
  ...
  /**
   *  Creates a new instance of MagnetcyclingWindow
   *
   *@param  aDocument  The XalDocument for this application.
   */
  public MagnetcyclingWindow(XalDocument aDocument) {
    super(aDocument);
    makeContent();
    pack();
  }
