...
class Warm_Linac_RF_SetUp_OpenXAL_Document(AcceleratorDocument):
	def __init__(self,url = null):
		...
		lib.constants_lib.const_path_dict["XAL_XML_ACC_FILES_DIRS_PATH"] = "/home/shishlo/xaldev_xml"
		lib.constants_lib.const_path_dict["OPENXAL_XML_ACC_FILES_DIRS_PATH"] = "/home/shishlo/openxal/core/test/resources/config"
		lib.constants_lib.const_path_dict["WARM_LINAC_SETUP_FILES_DIR_PATH"] = ""
		default_url = self.getDefaultFolderURL()
		if(default_url != None):
			path = self.getDefaultFolderURL().getPath()
			path = path.replace("%20"," ")
			lib.constants_lib.const_path_dict["WARM_LINAC_SETUP_FILES_DIR_PATH"] = path		
