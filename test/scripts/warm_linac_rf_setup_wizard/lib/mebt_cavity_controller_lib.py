...
class MEBT_Cavity_Controller(Abstract_Cavity_Controller):
	...
	def findGuessCavParametersAfterSineLikeScan(self):	
		...
		cav_amp_coeff = self.cav_wrapper.cav_amp_coeff
		cav_amp_coeff *= (1.0-0.01*self.guess_cav_amp_shift_text.getValue())
		self.cav_wrapper.cav_amp_coeff = cav_amp_coeff
		self.cav_wrapper.newAmp = self.cav_wrapper.design_amp/cav_amp_coeff
