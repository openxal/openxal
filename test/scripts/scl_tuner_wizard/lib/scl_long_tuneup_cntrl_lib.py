...
from scl_long_tuneup_kin_meter_cntrl_lib import SCL_Kin_Meter_Controller
from scl_long_tuneup_magnet_scaling_cntrl_lib import Magnet_Scaler_Controller
from scl_long_tuneup_long_twiss_cntrl_lib import SCL_Long_Twiss_Analysis_Controller
from scl_long_tuneup_cavity_failure_test_cntrl_lib import SCL_Cavity_Failure_Test_Controller
from bpm_time_shift_scan_manager_cntrl_lib import BPM_Time_Shift_Scan_Controller
from dispersion_measurement_cntrl_lib import Dispersion_Measurement_Controller
...
class SCL_Long_TuneUp_Controller:
	def __init__(self,linac_wizard_document):
		...
		lst = ArrayList()
		for seqName in ["SCLMed","SCLHigh","HEBT1"]:	
		...
		self.scl_long_tuneup_kin_meter_controller = SCL_Kin_Meter_Controller(self)
		self.scl_long_tuneup_magnet_scaler_controller = Magnet_Scaler_Controller(self)
		self.scl_long_twiss_analysis_controller = SCL_Long_Twiss_Analysis_Controller(self)
		self.scl_long_cavity_failure_test_controller = SCL_Cavity_Failure_Test_Controller(self)
		self.bpm_time_shift_scan_conroller = BPM_Time_Shift_Scan_Controller(self)
                self.dispersion_measurement_controller = Dispersion_Measurement_Controller(self)
		...
		self.tabbedPane.add("CCL Energy Meter",self.scl_long_tuneup_kin_meter_controller.getMainPanel())
		self.tabbedPane.add("SCL Energy Meter",self.scl_long_tuneup_energy_meter_controller.getMainPanel())
		self.tabbedPane.add("Magnet Scaler",self.scl_long_tuneup_magnet_scaler_controller.getMainPanel())
		self.tabbedPane.add("BPMs Time Shift Scan",self.bpm_time_shift_scan_conroller.getMainPanel())
		self.tabbedPane.add("Long. Twiss",self.scl_long_twiss_analysis_controller.getMainPanel())
		self.tabbedPane.add("Cavity Failure Test",self.scl_long_cavity_failure_test_controller.getMainPanel())
                self.tabbedPane.add("Dispersion measurement",self.dispersion_measurement_controller.getMainPanel())
	...
	def clean(self):
		...
		self.scl_long_tuneup_kin_meter_controller.clean()
		self.scl_long_twiss_analysis_controller.clean()
                self.dispersion_measurement_controller.clean()
	...
	def updateAllTables(self):
		...
		self.scl_long_tuneup_kin_meter_controller.updateTables()
		self.scl_long_twiss_analysis_controller.updateTables()
                self.dispersion_measurement_controller.updateTables()
	...
	def writeDataToXML(self,root_da):
		...
		self.scl_long_tuneup_kin_meter_controller.writeDataToXML(root_da)
	...
	def readDataFromXML(self,root_da):		
		...
		self.scl_long_tuneup_kin_meter_controller.readDataFromXML(root_da)
