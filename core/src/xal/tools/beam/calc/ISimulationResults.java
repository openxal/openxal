...
public interface ISimulationResults {
     ...
     * @since  Nov 15, 2013
     */
    public interface ISimLocResults<S extends ProbeState<S>> extends ISimulationResults  {
     ...
     * @version Nov 7, 2013
     */
    public interface ISimEnvResults<S extends ProbeState<S>>  extends ISimulationResults {
