...
public class ProbeXmlParser {
	 ...
	 */
	public static Probe<? extends ProbeState<?>> parse(String fileUri) throws ParsingException {
	 ...
	 * @since  Apr 14, 2011
	 */
	public static Probe<? extends ProbeState<?>> parseDataAdaptor(DataAdaptor adaptor) throws ParsingException {
		ProbeXmlParser parser = new ProbeXmlParser();
	 ...
	 * @return the Probe object described by the XML file
	 */
	public Probe<? extends ProbeState<?>> parseProbeFile(String fileUri) throws ParsingException {
	 ...
	 * @since  Apr 14, 2011
	 */
	public Probe<? extends ProbeState<?>> parseAdaptor(DataAdaptor adaptor) throws ParsingException {
