...
public class R3x3 implements java.io.Serializable {
    ...
    public enum Position  {
         ...
         */
        public static EnumSet<Position> getUpperTriangle() { return EnumSet.of(XY, XZ, YZ); };
         ...
         */
        public static EnumSet<Position> getDiagonal()      { return EnumSet.of(XX, YY, ZZ); };
         ...
         */
        public static EnumSet<Position> getLowerTriangle() { return EnumSet.of(YX, ZX, ZY); };
...
//        Jama.Matrix     matRes;     // resultant vector
        ...
        throws IllegalArgumentException, NumberFormatException
    {
        ...
        if (tokArgs.countTokens() != 9)
            throw new IllegalArgumentException("R3x3(strTokens) - wrong number of token strings: " + strTokens);
