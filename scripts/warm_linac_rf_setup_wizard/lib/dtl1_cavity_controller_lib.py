...
class Scan_Main_Panel(JPanel):
	def __init__(self,main_loop_controller,cav_controller):
		...
		self.full_scan_phase_step_text = DoubleInputTextField(15.0,ScientificNumberFormat(3),6)
		time_step_label = JLabel(" sleep time[sec]=",JLabel.RIGHT)
		self.time_step_text = DoubleInputTextField(2.2,ScientificNumberFormat(3),6)
		...
		self.start_fit_phase_text = DoubleInputTextField(0.0,ScientificNumberFormat(3),6)
		stop_fit_phase_label = JLabel(" to phase [deg]=",JLabel.RIGHT)
		self.stop_fit_phase_text = DoubleInputTextField(0.0,ScientificNumberFormat(3),6)
