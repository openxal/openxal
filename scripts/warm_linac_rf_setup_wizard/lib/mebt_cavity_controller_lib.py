...
class Scan_Main_Panel(JPanel):
	def __init__(self,main_loop_controller,cav_controller):
		...
		self.full_scan_phase_step_text = DoubleInputTextField(20.0,ScientificNumberFormat(3),6)
		time_step_label = JLabel(" sleep time[sec]=",JLabel.RIGHT)
		self.time_step_text = DoubleInputTextField(1.5,ScientificNumberFormat(3),6)
		min_bpm_amp_label = JLabel("    Min BPM ampitude[mA]=",JLabel.RIGHT)
		self.min_bpm_amp_text = DoubleInputTextField(1.0,ScientificNumberFormat(3),6)
		...
		self.min_cav_amp_text =  DoubleInputTextField(0.0,ScientificNumberFormat(6),8)
		max_cav_amp_label = JLabel(" Max=",JLabel.RIGHT)
		self.max_cav_amp_text =  DoubleInputTextField(0.0,ScientificNumberFormat(6),8)
		step_cav_amp_label = JLabel("N amp. steps=",JLabel.RIGHT)
		self.nsteps_cav_amp_text =  DoubleInputTextField(2.0,ScientificNumberFormat(2),5)
		live_cav_amp_label = JLabel(" Live Ampl.=",JLabel.RIGHT)
		self.live_cav_amp_text =  DoubleInputTextField(0.0,ScientificNumberFormat(6),8)
		...
		self.scan_phase_width_text = DoubleInputTextField(30.0,ScientificNumberFormat(3),6)
		scan_phase_step_label = JLabel("  Phase step[deg]=",JLabel.RIGHT)
		self.scan_phase_step_text = DoubleInputTextField(2.0,ScientificNumberFormat(3),6)
		...
		self.bpm_iter_avg_text = DoubleInputTextField(5,ScientificNumberFormat(2),4)
		bpm_iter_fitting_steps_label = JLabel("   steps=",JLabel.RIGHT)
		self.bpm_iter_steps_text = DoubleInputTextField(2,ScientificNumberFormat(2),4)
...
class Local_BPMs_Table_Panel(JPanel):
	def __init__(self,main_loop_controller,cav_controller):
		...
		self.sine_min_acc_phase_text =  DoubleInputTextField(0.0,ScientificNumberFormat(6),10)
		sine_max_acc_phase_label = JLabel("Max. acc. phase[deg]=",JLabel.RIGHT)
		self.sine_max_acc_phase_text =  DoubleInputTextField(0.0,ScientificNumberFormat(6),10)
		zero_acc_phase_label = JLabel("Zero acc. phase[deg]=",JLabel.RIGHT)
		self.zero_acc_phase_text =  DoubleInputTextField(0.0,ScientificNumberFormat(6),10)
		zero_acc_phase_err_label = JLabel("Err. Zero acc. phase[deg]=",JLabel.RIGHT)
		self.zero_acc_phase_err_text =  DoubleInputTextField(0.0,ScientificNumberFormat(6),10)
		cav_energy_gain_label = JLabel("Cavity's E0TL [keV]=",JLabel.RIGHT)
		self.cav_energy_gain_text =  DoubleInputTextField(0.0,ScientificNumberFormat(6),10)
