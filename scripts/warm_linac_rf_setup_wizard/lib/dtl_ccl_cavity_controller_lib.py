...
class Scan_Main_Panel(JPanel):
	def __init__(self,main_loop_controller,cav_controller):
		...
		self.full_scan_phase_step_text = DoubleInputTextField(10.0,ScientificNumberFormat(3),6)
		time_step_label = JLabel(" sleep time[sec]=",JLabel.RIGHT)
		self.time_step_text = DoubleInputTextField(1.9,ScientificNumberFormat(3),6)
		full_scan_fit_time_label = JLabel(" Fit time[sec]=",JLabel.RIGHT)
		self.full_scan_fit_time_text = DoubleInputTextField(10.,ScientificNumberFormat(3),6)
		...
		self.use_cav_off_text =  DoubleInputTextField(0.0,ScientificNumberFormat(2),5)
		...
		self.scan_phase_step_text = DoubleInputTextField(3.0,ScientificNumberFormat(3),6)
		...
		self.start_fit_phase_text = DoubleInputTextField(0.0,ScientificNumberFormat(3),8)
		stop_fit_phase_label = JLabel(" to phase [deg]=",JLabel.RIGHT)
		self.stop_fit_phase_text = DoubleInputTextField(0.0,ScientificNumberFormat(3),8)
		n_points_fit_label = JLabel(" fit points=",JLabel.RIGHT)
		self.n_points_fit_text = DoubleInputTextField(10.0,ScientificNumberFormat(2),6)
		time_limit_fit_label = JLabel(" Fit time[sec]=",JLabel.RIGHT)
		self.time_limit_fit_text = DoubleInputTextField(20.0,ScientificNumberFormat(2),6)
...
class Local_BPMs_and_Params_Tables_Panel(JPanel):
	def __init__(self,main_loop_controller,cav_controller):
		...
		self.pasta_error_text = DoubleInputTextField(0.0,ScientificNumberFormat(6),12)
